							...
							<div class="col-sm-12 col-md-12">
								...
								<?php if($latest_version['status']): ?>
									<div id="not-installed-info">
										...
										<h6><span class="text-danger fs-14 font-weight-bold"><?php echo e(__('IMPORTANT!')); ?> </span><?php echo e(__('Read the Update tab in the documentation for any update instructions')); ?>.</h6>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ku52g0exgkyh/public_html/resources/views/admin/settings/upgrade/index.blade.php ENDPATH**/ ?>