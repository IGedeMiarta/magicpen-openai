					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-16 number-font"><?php echo e(__('Social Media Post (Business)')); ?> <?php if($template->professional): ?> <span class="fs-8 btn btn-yellow ml-2"><i class="fa-sharp fa-solid fa-crown mr-2"></i><?php echo e(__('Pro')); ?></span> <?php endif; ?></h6>
								</div>
								<div>
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Company name')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" placeholder="e.g. XYZ" required>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Provide company description')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" placeholder="e.g. XYZ is a leading toy making company" required></textarea>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('What is the post about?')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
									<textarea type="text" rows=5 class="form-control <?php $__errorArgs = ["post"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="post" name="post" placeholder="e.g. we released a new version of kids favorite toy" required></textarea>
									<?php $__errorArgs = ['post'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
										<p class="text-danger"><?php echo e($errors->first('post')); ?></p>
									<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ku52g0exgkyh/public_html/resources/views/user/templates/social-post-business.blade.php ENDPATH**/ ?>