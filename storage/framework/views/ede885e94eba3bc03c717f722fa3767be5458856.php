                ...
                <div class="row text-center h-100vh align-items-center">
                    <div class="col-md-12">
                        ...
                        <h5><?php echo e(__('We apologize for the inconvenience but')); ?> <span
                            ...
                            <?php echo e(__('is currently undergoing planned maintenance')); ?>.</h5>
                    </div>
                </div>
            </div>
        <?php else: ?>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <nav class="navbar navbar-expand-lg navbar-light w-100"
                                                ...
                                                <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img id="brand-img"
                                                        src="<?php echo e(URL::asset('img/brand/logo.png')); ?>"
                                                        alt=""></a>
                                                ...
                                                <div class="collapse navbar-collapse section-links" id="navbarNav">
                                                    <ul class="navbar-nav">
                                                        <li class="nav-item">
                                                            <a class="nav-link scroll active"
                                                                href="#main-wrapper"><?php echo e(__('Home')); ?> <span
                                                                    class="sr-only">(current)</span></a>
                                                        </li>
                                                        <?php if(config('frontend.pricing_section') == 'on'): ?>
                                                            <li class="nav-item">
                                                                <a class="nav-link scroll"
                                                                    href="#prices-wrapper"><?php echo e(__('Prices')); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if(config('frontend.blogs_section') == 'on'): ?>
                                                            <li class="nav-item">
                                                                <a class="nav-link scroll"
                                                                    href="#blog-wrapper"><?php echo e(__('Blogs')); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if(config('frontend.faq_section') == 'on'): ?>
                                                            <li class="nav-item">
                                                                <a class="nav-link scroll"
                                                                    href="#faq-wrapper"><?php echo e(__('FAQs')); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                        <?php if(config('frontend.contact_section') == 'on'): ?>
                                                            <li class="nav-item">
                                                                <a class="nav-link scroll"
                                                                    href="#contact-wrapper"><?php echo e(__('Contact Us')); ?></a>
                                                            </li>
                                                        <?php endif; ?>
                                                            ...
                                                            <?php if(Route::has('login')): ?>
                                                                <div>
                                                                    <?php if(auth()->guard()->check()): ?>
                                                                        <a href="<?php echo e(route('user.templates')); ?>"
                                                                            class="action-button dashboard-button pl-5 pr-5"><?php echo e(__('Dashboard')); ?></a>
                                                                    <?php else: ?>
                                                                        <a href="<?php echo e(route('login')); ?><?php echo e(request()->get('ref') ? '?ref=' . request()->get('ref') : ''); ?>"
                                                                            class="btn btn-primary special-action-button"
                                                                            id="login-button"><?php echo e(__('Login')); ?></a>

                                                                        <?php if(config('settings.registration') == 'enabled'): ?>
                                                                            <?php if(Route::has('register')): ?>
                                                                                <a href="<?php echo e(route('register')); ?><?php echo e(request()->get('ref') ? '?ref=' . request()->get('ref') : ''); ?>"
                                                                                    class="ml-2 action-button register-button pl-5 pr-5"><?php echo e(__('Sign Up')); ?></a>
                                                                            <?php endif; ?>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                </div>
    ...
    ========================================================-->
                    <footer id="welcome-footer">
                        ...
                        <div id="footer" class="container text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12" id="footer-logo">
                                    ...
                                    <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi ut
                                        culpa maiores maxime illo nostrum aut totam, porro dolore minima</p>

                                    <div class="dropdown header-locale" id="frontend-local">
                                        <a class="nav-link icon" data-bs-toggle="dropdown">
                                            <span class="fs-17 fa fa-globe pr-2"></span><span class="fs-12"
                                                style="vertical-align:middle"><?php echo e(Config::get('locale')[App::getLocale()]['code']); ?></span>
                                        </a>
                                            ...
                                            <div class="local-menu">
                                                <?php $__currentLoopData = Config::get('locale'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($lang != App::getLocale()): ?>
                                                        <a href="<?php echo e(route('locale', $lang)); ?>"
                                                            class="dropdown-item d-flex">
                                                            <div class="text-info"><i
                                                                    class="flag flag-<?php echo e($language['flag']); ?> mr-3"></i>
                                                            </div>
                                                            <div>
                                                                <span
                                                                    class="font-weight-normal fs-12"><?php echo e($language['display']); ?></span>
                                                            </div>
                                                        </a>
                                                    <?php endif; ?>
                                ...
                                <div class="col-md-8 col-sm-12" id="footer-links">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><a href="<?php echo e(route('terms')); ?>"><?php echo e(__('Terms & Conditions')); ?></a>
                                                </li>
                                                <li><a href="<?php echo e(route('privacy')); ?>"><?php echo e(__('Privacy Policy')); ?></a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-md-3 col-sm-12 footer-connect pr-0">
                                            ...
                                            <h6><?php echo e(__('Follow up on social media to find out the latest updates')); ?>.
                                            </h6>

                                            <ul id="footer-icons" class="list-inline">
                                                <?php if(config('frontend.social_linkedin')): ?>
                                                    <a href="<?php echo e(config('frontend.social_linkedin')); ?>"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                                class="footer-icon fa-brands fa-linkedin"></i></li>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if(config('frontend.social_twitter')): ?>
                                                    <a href="<?php echo e(config('frontend.social_twitter')); ?>"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                                class="footer-icon fa-brands fa-twitter"></i></li>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if(config('frontend.social_instagram')): ?>
                                                    <a href="<?php echo e(config('frontend.social_instagram')); ?>"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                                class="footer-icon fa-brands fa-instagram"></i></li>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if(config('frontend.social_facebook')): ?>
                                                    <a href="<?php echo e(config('frontend.social_facebook')); ?>"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                                class="footer-icon fa-brands fa-facebook"></i></li>
                                                    </a>
                                                <?php endif; ?>
                                            ...
                                            <a href="<?php echo e(route('register')); ?>"
                                                class="btn btn-primary pl-5 pr-5"><?php echo e(__('Sign Up Now')); ?></a>
                        ...
                        <div id="copyright" class="container">
                            ...
                            <p class="copyright-left"><?php echo e(__('Copyright')); ?> © <?php echo e(date('Y')); ?> <a
                                    href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.name')); ?></a>
                                <?php echo e(__('All rights reserved')); ?></p>

                            <div>
                                <p class="copyright-right"><a href="<?php echo e(route('terms')); ?>"
                                        target="_blank"><?php echo e(__('Terms & Conditions')); ?></a></p>
                                <p class="copyright-right"><a href="<?php echo e(route('privacy')); ?>"
                                        target="_blank"><?php echo e(__('Privacy Policy')); ?></a><span>|</span></p>
                            </div>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/magic/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>