...
<?php $__env->startSection('content'); ?>
        ...
        <section id="main-wrapper" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
        ...
        <?php if(config('frontend.features_section') == 'on'): ?>
            <section id="features-wrapper" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-8 mb-8">
                        <div class="col-md-12 title">
                            <h4><b><?php echo e(config('app.name')); ?><span class="text-primary"> <?php echo e(__('Benefits')); ?></span></b></h4>
                            <h5><?php echo e(__('Enjoy the full flexibility of the platform with ton of features')); ?></h5>
                        </div>
                    </div>
        
                        
                    <!-- LIST OF SOLUTIONS -->
                    <div class="row d-flex" id="solutions-list" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">                                                                          
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('The latest AI technology is constantly evolving and transforming various industries with its capabilities. As AI technology advances, it brings both new possibilities and challenges, including ethical considerations that need to be addressed.')); ?></p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('Our AI language model is capable of processing and generating text in more than 25 languages, making it a versatile and useful tool for communication and content creation.')); ?></p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('Our platform offers 2FA account protection to enhance security and safeguard user data from unauthorized access or theft.')); ?></p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('AI text editing is now made easy with the latest advancements in natural language processing and machine learning. Users can now edit AI-generated text with ease using intuitive and user-friendly tools, saving time and effort while still maintaining the quality and accuracy of the content.')); ?></p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('Our AI text processing tool allows users to easily export their results in both PDF and Word formats, providing a convenient and accessible way to share and store their content.')); ?></p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p><?php echo e(__('With the latest AI technology, its now possible to generate high quality images from text input, providing a quick and efficient way to create visual content.')); ?>
                        ...
                        <div class="col-md-4 col-sm-12 d-flex">
                            ...
                            <div class="feature-text">
                                ...
                                <p> <?php echo e(__('Magic Pen is a powerful platform that utilizes the most sophisticated AI technology to generate high quality text and visual content.')); ?></p>
                                
                                <p><?php echo e(__('With advanced natural language processing and machine learning algorithms, Magic Pen empowers users to create compelling and engaging content with ease.')); ?></p>
                            </div>
                                                                    ...
                                                                    <div class="card border-0 p-4 pl-5 pr-5 pt-7 price-card <?php if($subscription->featured): ?> price-card-border <?php endif; ?>">
                                                                        ...
                                                                        <div class="plan">			
                                                                            ...
                                                                            <div class="text-center action-button mt-2 mb-5">
                                                                                <a href="<?php echo e(route('user.plan.subscribe', $subscription->id)); ?>" class="btn btn-primary"><?php echo e(__('Donate Now')); ?></a>                                                														
                                                                            </div>
    ...
    <script type="text/javascript">
		$(function () {
            ...
            var typed = new Typed('#typed', {
                strings: ['<h1><span><?php echo e(__('Business Owners ?')); ?></span></h1>', 
                            '<h1><span><?php echo e(__('Startup Teams ?')); ?></span></h1>',
                            '<h1><span><?php echo e(__('Social Media Managers ?')); ?></span></h1>',
                            '<h1><span><?php echo e(__('Email Marketers ?')); ?></span></h1>',
                            '<h1><span><?php echo e(__('Marketing Agencies ?')); ?></span></h1>',
                            '<h1><span><?php echo e(__('Digital Advertisers ?')); ?></span></h1>'],
                typeSpeed: 40,
                backSpeed: 40,
                backDelay: 2000,
                loop: true,
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/magic/resources/views/home.blade.php ENDPATH**/ ?>