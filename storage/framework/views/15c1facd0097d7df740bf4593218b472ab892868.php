					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="card overflow-hidden border-0">
								<div class="card-body d-flex">
									<div class="usage-info w-100">
										<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Time Saved')); ?> <span class="text-muted">(<?php echo e(__('Current Month')); ?>)</span></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/magic/resources/views/user/dashboard/index.blade.php ENDPATH**/ ?>