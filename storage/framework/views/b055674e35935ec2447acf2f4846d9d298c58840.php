		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			<div class="card border-0" id="chat-system">
				<div class="card-header">
					<div class="w-100">
						<h3 class="card-title"><i class="fa-solid fa-message-captions mr-2 text-info"></i><?php echo e(__('AI Chat Bot')); ?></h3>	
					</div>
					<div class="w-100 text-right">				
						...
						<a id="clear" class="template-button" onclick="return clearConversation();" href="#"><i class="fa-solid fa-message-xmark table-action-buttons table-action-buttons-big delete-action-button" data-tippy-content="<?php echo e(__('Clear Chat Conversation')); ?>"></i></a>
...
unset($__errorArgs, $__bag); ?> border-right-0" style="margin-right: 80px;" id="message" name="message" placeholder="<?php echo e(__('Enter your question here...')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ku52g0exgkyh/public_html/resources/views/user/chat/index.blade.php ENDPATH**/ ?>