...
@section('content')
        ...
        <section id="main-wrapper" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        @if (config('frontend.features_section') == 'on')
            <section id="features-wrapper" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-8 mb-8">
                        <div class="col-md-12 title">
                            <h4><b>{{ config('app.name') }}<span class="text-primary"> {{ __('Benefits') }}</span></b></h4>
                            <h5>{{ __('Enjoy the full flexibility of the platform with ton of features') }}</h5>
                        </div>
                    </div>
        
                        
                    <!-- LIST OF SOLUTIONS -->
                    <div class="row d-flex" id="solutions-list" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">                                                                          
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('The latest AI technology is constantly evolving and transforming various industries with its capabilities. As AI technology advances, it brings both new possibilities and challenges, including ethical considerations that need to be addressed.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Our AI language model is capable of processing and generating text in more than 25 languages, making it a versatile and useful tool for communication and content creation.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Our platform offers 2FA account protection to enhance security and safeguard user data from unauthorized access or theft.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('AI text editing is now made easy with the latest advancements in natural language processing and machine learning. Users can now edit AI-generated text with ease using intuitive and user-friendly tools, saving time and effort while still maintaining the quality and accuracy of the content.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Our AI text processing tool allows users to easily export their results in both PDF and Word formats, providing a convenient and accessible way to share and store their content.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('With the latest AI technology, its now possible to generate high quality images from text input, providing a quick and efficient way to create visual content.') }}
                                        </p>
                        ...
                        <div class="col-md-4 col-sm-12 d-flex">
                            ...
                            <div class="feature-text">
                                ...
                                <p> {{ __('Magic Pen is a powerful platform that utilizes the most sophisticated AI technology to generate high quality text and visual content.') }}</p>
                                
                                <p>{{ __('With advanced natural language processing and machine learning algorithms, Magic Pen empowers users to create compelling and engaging content with ease.') }}</p>
                            </div>
                                                                    ...
                                                                    <div class="card border-0 p-4 pl-5 pr-5 pt-7 price-card @if ($subscription->featured) price-card-border @endif">
                                                                        ...
                                                                        <div class="plan">			
                                                                            ...
                                                                            <div class="text-center action-button mt-2 mb-5">
                                                                                <a href="{{ route('user.plan.subscribe', $subscription->id) }}" class="btn btn-primary">{{ __('Donate Now') }}</a>                                                														
                                                                            </div>
    ...
    <script type="text/javascript">
		$(function () {
            ...
            var typed = new Typed('#typed', {
                strings: ['<h1><span>{{ __('Business Owners ?') }}</span></h1>', 
                            '<h1><span>{{ __('Startup Teams ?') }}</span></h1>',
                            '<h1><span>{{ __('Social Media Managers ?') }}</span></h1>',
                            '<h1><span>{{ __('Email Marketers ?') }}</span></h1>',
                            '<h1><span>{{ __('Marketing Agencies ?') }}</span></h1>',
                            '<h1><span>{{ __('Digital Advertisers ?') }}</span></h1>'],
                typeSpeed: 40,
                backSpeed: 40,
                backDelay: 2000,
                loop: true,
