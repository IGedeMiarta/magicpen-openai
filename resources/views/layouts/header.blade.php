...
<link rel="stylesheet" href="{{ URL::asset('icons/fontawesome/css/fontawesome.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('icons/fontawesome/css/brands.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('icons/fontawesome/css/regular.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('icons/fontawesome/css/solid.min.css') }}">
