            ...
            <div class="col-md-5 col-sm-12 h-100" id="login-responsive">
                <div class="card-body pr-10 pl-10 pt-10">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <h3 class="text-center font-weight-bold mb-8">{{ __('Welcome Back to') }} <span class="text-info"><a
                                    href="{{ url('/') }}">{{ config('app.name') }}</a></span></h3>
                        ...
                        <div class="form-group mb-0">
                            ...
                            @if (config('settings.registration') == 'enabled')
                                <a href="{{ route('register') }}{{ request()->get('ref') ? '?ref=' . request()->get('ref') : '' }}"
                                    class="btn btn-cancel">{{ __('Sign Up') }}</a>
                            @endif

                        </div>

                        <p class="fs-10 text-muted pt-3">{{ __('By continuing, you agree to our') }} <a
                                href="{{ route('terms') }}" class="text-info">{{ __('Terms and Conditions') }}</a>
                            {{ __('and') }} <a href="{{ route('privacy') }}"
                                class="text-info">{{ __('Privacy Policy') }}</a></p>
